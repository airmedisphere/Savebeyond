...
API_ID = int(os.environ.get("API_ID", "26182818"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "e98cc55fabed0fce53269188fa3a0e63")

# Your Owner / Admin Id For Broadcast 
ADMINS = int(os.environ.get("ADMINS", "7441256901"))
...
CHANNEL_ID = os.environ.get("CHANNEL_ID", "-1003855755827")
...
WAITING_TIME = int(os.environ.get("WAITING_TIME", "2")) # time in seconds
